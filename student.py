...
class Student:
    def __init__(self,root):
        ...
        img = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\student_scan2.png")
        ...
        #second image
        img1 = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\student_scan.jpg")
        ...
        #background image
        img3 = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\bg2.jpg")
        ...
        img_left = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\left_frame3.webp")
        ...
        course_combo["values"]=("Select Course","BE","MEDICAL","BCA","BBA")
        ...
        year_combo["values"]=("Selct Year ","2022-23","2023-24","2024-25","2025-26")
        ...
        img_right=Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\student_scan2.png")
  ...
  #function declaration
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_id.get()=="":
            ...
            try:
              conn=mysql.connector.connect(host="localhost",username="root",password="Abjal@5696",database="face_recognition")
    ...
    def generate_dataset(self):
         if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_id.get()=="":
            ...
            try:
                 ...
                 face_classifire=cv2.CascadeClassifier(r"C:\college-project\face_recognition_attendance_system_2\haarcascade_frontalface_default.xml")
                 ...
                 while True:
                     ...
                     if face_cropped(frame) is not None:
                         ...
                         file_name_path=(r"C:\college-project\face_recognition_attendance_system_2\data/user."+str(id)+"."+str(img_id)+".jpg")
