...
class Face_recognition:
    def __init__(self,root):
        ...
        # First image
        img_top = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\face_reco_1.webp")
        ...
        # Second image
        img_bottom = Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\face_reco_2.webp")
    ...
    def msrk_attendance(self,i,r,n,d):
        with open(r"C:\college-project\face_recognition_attendance_system_2\attendance.csv","r+",newline="\n") as f:
    ...
    def face_reco(self):
       ...
       def recognize(img,clf,facecascade):
            ...
            return img
       facecascade=cv2.CascadeClassifier(r"C:\college-project\face_recognition_attendance_system_2\haarcascade_frontalface_default.xml")
       clf=cv2.face.LBPHFaceRecognizer_create()
       clf.read(r"C:\college-project\face_recognition_attendance_system_2\classifire.xml")
