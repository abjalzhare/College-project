...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\3_people.webp")
        ...
        img_bottom=Image.open(r"C:\college-project\face_recognition_attendance_system_2\college_photo\people.png")
    ...
    def train_classifire(self):
        data_dir=(r"C:\college-project\face_recognition_attendance_system_2\data")
        ...
        clf.train(faces,ids)
        clf.write(r"C:\college-project\face_recognition_attendance_system_2\classifire.xml")
